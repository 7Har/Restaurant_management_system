"""
Django settings for fdbtest project.
...
ROOT_URLCONF = 'fdbtest.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': ['fdbtest/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'fdbtest.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'root',  # Name of the database*
